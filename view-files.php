              ...
              <?php
                if( count($files) === 0) {
                  ...
                  foreach ($files as $filename => $filemtime)
                  {
                    ...
                    $isImage = $fileInfo['extension'] === "jpg";
                    ...
                    if( $isImage) {
                      ...
                      $fileRelativePath = $config['folderImg'] .'/' . basename($filename);
                    ...
                    <?php
                      ...
                      $fileRelativePath = $config['folderVideo'] .'/' . basename($filename);
